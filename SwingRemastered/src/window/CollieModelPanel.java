...
public final class CollieModelPanel extends JPanel implements PropertyChangeListener {
	...
	private AbstractAction[] theActions = { new AddInstanceAction(ADD_INSTANCE,
			new ImageIcon(Collie.class.getResource("/images/instanceButton_large.gif")), theInstanceNodeFactory),
			new AddInstanceAction(ADD_MULTI_INSTANCE,
					new ImageIcon(Collie.class.getResource("/images/multiButton_large.gif")),
					theMultiInstanceNodeFactory),
			new AddInstanceAction(ADD_ACTOR, new ImageIcon(Collie.class.getResource("/images/actorButton_large.gif")),
					theActorNodeFactory),
			null, new AddNoteAction(ADD_NOTE, new ImageIcon(Collie.class.getResource("/images/noteButton_large.gif"))),
			null,
			new RelationToolAction(SELECTION_TOOL,
					new ImageIcon(Collie.class.getResource("/images/selectionButton_large.gif")), theSelectionTool,
					Cursor.DEFAULT_CURSOR),
			new RelationToolAction(ASSOCIATION_TOOL,
					new ImageIcon(Collie.class.getResource("/images/associationButton_large.gif")), theAssociationTool,
					Cursor.CROSSHAIR_CURSOR),
			new RelationToolAction(AGGREGATION_TOOL,
					new ImageIcon(Collie.class.getResource("/images/aggregationButton_large.gif")), theAggregationTool,
					Cursor.CROSSHAIR_CURSOR) };
	...
	public class AddInstanceAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (event.getActionCommand().equals(ADD_INSTANCE) || event.getActionCommand().equals(ADD_ACTOR)) {
	...
	public class ModelPanelMouseListener extends MouseAdapter {
		...
		public void mousePressed(MouseEvent event) {
			...
			if (SwingUtilities.isRightMouseButton(event)) {
				if (CollieModelPanel.this.selectedElement != null)
					CollieModelPanel.this.selectedElement.doRightMousePressed(event,
							CollieModelPanel.this.graphicsContext);
				else {

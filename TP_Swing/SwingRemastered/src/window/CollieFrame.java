...
// ---------- private -------------------------------------
    ...
    private Object[][] fileMenus = {
    	...
    	{ fileSaveAsAction,	new Character('a'),	TRUE,	FALSE	}, // Avant FALSE
    	{ null								},
    	{ fileExitAction,	new Character('x'),	TRUE,	TRUE	} // Avant FALSE
    };
...
// ---------- inner class ---------------------------------
    ...
    class HelpAboutAction extends AbstractAction {
	    ...
	    message += "Author  : David TOCAVEN et Lucien RAKOTOMALALA\n";
	    message += "Version : 1.01\n";
	    message += "Date    : October 2017";
